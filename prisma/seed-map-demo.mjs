...
const demoCompanies = [
  ...
  {
    slug: "map-demo-coffee-nevsky",
    name: "Nevsky Brew",
    description: "Saint Petersburg coffee partner for city cluster testing.",
    categorySlug: "coffee",
    address: "Russia, Saint Petersburg, Nevsky Prospect, 28",
  ...
  {
    slug: "map-demo-food-novosibirsk-opera",
    name: "Opera Kitchen",
    description: "Novosibirsk dining partner near the opera theatre.",
    categorySlug: "food",
    address: "Russia, Novosibirsk, Krasny Avenue, 36",
    city: "Новосибирск",
    title: "Opera",
    latitude: 55.0302,
    longitude: 82.9204,
  ...
  {
    slug: "map-demo-fitness-ekb-center",
    name: "Ekb Motion",
    description: "Yekaterinburg fitness partner for regional map checks.",
    categorySlug: "fitness",
    address: "Russia, Yekaterinburg, Malysheva Street, 51",
    city: "Екатеринбург",
    title: "Center",
    latitude: 56.8389,
    longitude: 60.6057,
  ...
  {
    slug: "map-demo-retail-kazan-kremlin",
    name: "Kazan Select",
    description: "Kazan retail partner close to the historic center.",
    categorySlug: "retail",
    address: "Russia, Kazan, Bauman Street, 13",
    city: "Казань",
    title: "Bauman",
    latitude: 55.7961,
    longitude: 49.1064,
  ...
  {
    slug: "map-demo-health-krasnoyarsk-yenisei",
    name: "Yenisei Wellness",
    description: "Krasnoyarsk health partner for city-level clustering.",
    categorySlug: "health",
    address: "Russia, Krasnoyarsk, Mira Avenue, 91",
    city: "Красноярск",
    title: "Yenisei",
    latitude: 56.0106,
    longitude: 92.8526,
  ...
  {
    slug: "map-demo-food-nizhny-strelka",
    name: "Strelka Table",
    description: "Nizhny Novgorod restaurant partner near the Strelka area.",
    categorySlug: "food",
    address: "Russia, Nizhny Novgorod, Rozhdestvenskaya Street, 24",
  ...
  {
    slug: "map-demo-fitness-chelyabinsk-center",
    name: "Chelyabinsk Fit",
    description: "Chelyabinsk fitness partner for map density checks.",
    categorySlug: "fitness",
    address: "Russia, Chelyabinsk, Kirovka Street, 82",
    city: "Челябинск",
    title: "Kirovka",
    latitude: 55.1644,
    longitude: 61.4368,
  ...
  {
    slug: "map-demo-beauty-ufa-salavat",
    name: "Ufa Beauty Room",
    description: "Ufa beauty partner for city cluster visibility.",
    categorySlug: "beauty",
    address: "Russia, Ufa, Lenina Street, 5",
    city: "Уфа",
    title: "Lenina",
    latitude: 54.7351,
    longitude: 55.9587,
  ...
  {
    slug: "map-demo-coffee-samara-space",
    name: "Samara Space Coffee",
    description: "Samara coffee partner near the city center.",
    categorySlug: "coffee",
    address: "Russia, Samara, Leningradskaya Street, 55",
    city: "Самара",
    title: "Space",
    latitude: 53.1959,
    longitude: 50.1002,
