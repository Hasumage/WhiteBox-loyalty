...
const ruleSections = [
  ...
  },
  {
    ...
    text: [
      "Компания должна быть зарегистрирована в NearLoy и иметь активную оплаченную подписку NearLoy со скидкой не более 50% на дату определения победителя.",
      "Тестовые данные, дубли, фиктивные карточки и технические аккаунты сами по себе не дают права на участие.",
      "Компании, которые пользуются NearLoy бесплатно, условно бесплатно или со скидкой выше 50%, в счётчик и список участников не попадают.",
  ...
  },
  {
    ...
    text: [
      "Розыгрыш проводится после достижения цели: 50 российских компаний с активной оплаченной подпиской NearLoy без скидки выше 50%.",
        ...
        <div className="mt-8 overflow-hidden rounded-[2.25rem] border border-white/10 bg-white/[0.045] p-6 shadow-[0_0_70px_rgba(255,255,255,0.055)] sm:p-8">
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-3">
            {[
              ...
              { icon: ShieldCheck, label: "Условие", value: "Оплаченная подписка" },
            ].map((item) => (
