...
const needs = [
  {
    ...
    text: "Не чат на тысячу людей, а круг активных компаний: понятно кто чем занимается, где точки, какие подписки и репутация.",
  },
  {
    icon: HeartHandshake,
...
const clubRules = [
  "В клуб попадают владельцы или уполномоченные сотрудники активных компаний.",
...
export default function ClubConceptPage() {
  return (
    <ConceptPageShell
      ...
      title="Клуб NearLoy"
      description="Прототип закрытого клуба предпринимателей внутри NearLoy: активные участники, тёплые интро, совместные подписки, карта возможностей и репутация, которая строится на полезных действиях."
    >
      ...
      <section className="rounded-[2rem] border border-white/10 bg-white/[0.035] p-6">
        ...
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
          {[
            ["Company activity", "в клубе участвуют активные компании"],
